function roi_extract_parameters(options,analysis_version,model,contrasts,roitype,rois,subj)
...
for con = contrasts
    ...
    for roi = rois
        ...
        roiresultfile = fullfile(roiresultpath,['MeanBetas_' contrast_name '_' roi_name '.mat']);
