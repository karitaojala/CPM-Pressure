...
analysis_version = '07Feb23';
modelNo = 2;
[model,options] = get_model(options,modelNo);
% 1 = HRF - tonic phasic - RETROICOR, 24 motion
% 2 = HRF - tonic phasic - RETROICOR, noise ROI WMxCSF, 24 motion
% 3 = HRF - tonic phasic - RETROICOR, noise ROI WM CSF WMxCSF, 24 motion
% 4 = HRF - tonic phasic pmod - run-wise design (EXP/CON same column) - RETROICOR, noise ROI WM CSF WMxCSF, 24 motion
