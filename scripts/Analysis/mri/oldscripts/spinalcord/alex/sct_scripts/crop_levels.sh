...
sourcedir=/home/tinnermann/sct/data/PAM50/spinal_levels
...
cp ${sourcedir}/spinal_level_05.nii.gz ${targetdir}
cp ${sourcedir}/spinal_level_06.nii.gz ${targetdir}

gunzip spinal*.nii.gz
