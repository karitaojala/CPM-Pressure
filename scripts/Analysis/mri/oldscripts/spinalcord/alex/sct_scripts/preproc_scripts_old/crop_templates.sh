...
#~ sct_crop_image -i PAM50_t1.nii -dim 2 -start 785 -end 855 -o PAM50_t1_crop_1vs.nii 
#~ sct_crop_image -i PAM50_t2.nii -dim 2 -start 785 -end 855 -o PAM50_t2_crop_1vs.nii 
#~ sct_crop_image -i PAM50_cord.nii -dim 2 -start 785 -end 855 -o PAM50_cord_crop_1vs.nii 
#~ sct_crop_image -i PAM50_levels.nii -dim 2 -start 785 -end 855 -o PAM50_levels_crop_1vs.nii 
