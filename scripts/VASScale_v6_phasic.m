function P = VASScale_v6_phasic(P,O,varargin)
...
%     O.display.screen=2;
    ...
    durRating       = P.presentation.phasicStim.durationVAS;
    defaultRating 	= 50;%P.log.scaleInitVAS(P.currentTrial(1).N,P.currentTrial(1).nRating);
