...
% if P.startSection == 6
%     fprintf('\nExperiment ending.');
%     [abort]=ShowInstruction(P,O,8); % intentional 8 (not 6), as instructions in between
%     if abort;return;end
% end
...
if strcmp(P.env.hostname,'stimpc1')
    P.com.lpt.pressureOnset     = 32; % this covers both CHEPS trigger (4) and SCR/Spike (32)
