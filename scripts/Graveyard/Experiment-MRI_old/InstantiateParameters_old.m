...
if P.devices.arduino
    ...
    elseif strcmp(P.env.hostname,'isnb05cda5ba721') % own laptop
        ...
        P.com.arduino = 'COM14'; % CPAR: depends on PC - work laptop COM3 - experiment laptop COM5
        P.path.cpar = fullfile(cd,'..','LabBench.CPAR-master');
        disp('stimpc');
    end
end
...
P.pain.Calibration.painThresholdPreset          = [45 50];%P.awiszus.mu; % first for tonic stimuli, second for phasic stimuli
...
conditions_participant = [1 0 1 0];%conditions_list_rand(P.protocol.sbId,:);
...
P.pain.CPM.tonicRating.totalDuration       = P.pain.CPM.tonicStim.fullCycleDuration*P.pain.CPM.tonicRating.cycles+2*P.pain.CPM.tonicStim.startendRampDuration;%P.pain.CPM.tonicStim.totalDuration;%P.pain.CPM.tonicStim.fullCycleDuration + 2*P.pain.CPM.tonicStim.startendRampDuration;
