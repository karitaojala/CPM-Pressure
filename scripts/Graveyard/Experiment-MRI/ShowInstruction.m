...
if ~O.debug.toggleVisual
    ...
    if section == 1
        ...
        if strcmp(P.language,'de')
            ...
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Die ersten zwei Reize sind von geringer Intensität, damit Sie sich an das Gefühl gewöhnen können.', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Nach jedem weiteren Reiz werden Sie gebeten, eine Taste zu drücken,', 'center', upperEight+P.style.lineheight, P.style.white);
    ...
    elseif section == 2
        ...
        if strcmp(P.language,'de')
            ...
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'zu bewerten, wobei noch kein Druck ausgeübt wird.', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
            ...
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ['die ' keyPainful ' erhöht die Bewertung auf der Skala.'], 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
