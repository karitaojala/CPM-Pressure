...
if ~O.debug.toggleVisual
    ...
    if section == 1
        ...
        if strcmp(P.language,'de')
            ...
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Mit welcher Gliedmaße begonnen wird, wird zufällig entschieden. ', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
    ...
    elseif section == 2
        ...
        if strcmp(P.language,'de')
            ...
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Hier wird noch kein Druck auf Ihren Arm/Bein ausgeübt.', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
            ...
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Mit der linken Pfeiltaste können Sie die Bewertung auf der Skala verringern', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' und mit der rechten Pfeiltaste erhöhen.', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
    ...
    elseif section == 3
        ...
        if strcmp(P.language,'de')
            ...
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Zuerst werden alle Reize auf eine Gliedmaße (Arm oder Bein) angewendet.', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Danach auf die andere Gliedmaße (Arm oder Bein).', 'center', upperEight+P.style.lineheight, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
    ...
    elseif section == 6 % CPM experiment
        ...
        Screen('TextSize', P.display.w, P.style.fontsize);
        if strcmp(P.language,'de')
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'Der nächste Teil des Experiments beginnt bald.', 'center', upperEight-100, P.style.white);
            [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ' ', 'center', upperEight+P.style.lineheight, P.style.white);
